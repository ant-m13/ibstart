...
Полный реестр параметров и команд 1С для будущей поддержки и обратной совместимости приведён в [спецификации ibases и запуска](ibases-launch-spec.md); правила работы с материалами 1С:ИТС — в [политике лицензирования](1c-license-compliance.md).
