...
Чтобы узнать о новой версии, выберите **Справка → Проверить обновления…**. Проверка выполняется в фоне и обращается только к публичному GitHub Releases API. Если новая стабильная версия доступна, IBStart предложит открыть её страницу в браузере. Скачивание, замена EXE и установка не выполняются автоматически.
