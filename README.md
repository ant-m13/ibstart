...
- Команда **Справка → Проверить обновления…** в фоне сопоставляет встроенную версию с последним стабильным GitHub Release и при наличии новой версии предлагает открыть её страницу. Программа ничего не скачивает и не заменяет сама.
