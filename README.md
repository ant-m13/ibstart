...
- [Спецификация ibases и запуска 1С](docs/ibases-launch-spec.md) — аудит текущей реализации, полный реестр полей/параметров, лицензионная граница и план дальнейшей реализации.
