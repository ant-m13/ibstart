...
- Контекстное меню дерева дублирует запуск и операции со списком, позволяет добавлять элементы внутрь выбранной группы и менять порядок соседних элементов.
