  ...
  switch (command) {
    ...
    case kAdvancedHelpParameters:
      ...
      text = L"Необязательные ключи командной строки 1С, передаваемые при запуске выбранной базы. "
             L"Например: /AppArch x86_64_prt. Пароли и токены можно хранить здесь, но они будут видны в файле и интерфейсе; "
             L"в журналах и автоматически создаваемых диагностических сообщениях значения маскируются.";
      break;
    default:
      return;
  }
